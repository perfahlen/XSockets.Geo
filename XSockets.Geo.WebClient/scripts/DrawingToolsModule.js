...
* 
* Description:
* This module provides a set of tools for drawing and editting shapes on the map.
...
* in it. You can specify which tool options should appear in the toolbat using the 
        ...
        *******************************/
        ...
        var _options = {
            ...
            events: {
                ...
                drawingStarted: null,
                /// <field type='Function'>An event handler that is fired when the initial drawing of a shape is ended.</field>
                drawingEnded: null
            }
        };
...
Microsoft.Maps.moduleLoaded('DrawingTools');